...
#[get("")]
pub async fn get_queue(player: web::Data<PlayerData>) -> Result<HttpResponse, Error> {
...
#[delete("")]
pub async fn clear_queue(player: web::Data<PlayerData>) -> Result<HttpResponse, Error> {
...
#[get("length")]
pub async fn length(player: web::Data<PlayerData>) -> Result<HttpResponse, Error> {
    let player = player.lock().unwrap();
